...
- Pouvoir transformer le Markdown avant de l’exporter :
  - Très souvent, on utilise [remark](https://github.com/remarkjs/remark) pour enrichir le Markdown brut : par exemple, sur [vahor.fr](https://vahor.fr), les liens d’images ou autres sont relatifs au fichier Markdown (ex : `../../../public/fichier.txt`). Les garder tels quels n’est pas idéal, on veut retirer ce préfixe avant publication.
