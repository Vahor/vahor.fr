...
![Menu minecraft avec 4 livres dans la première ligne et des boutons d'action en dernière ligne](/projects/simple-schematics/menu-main.png)
...
![Tooltip d'information d'un dossier montrant les actions possibles](/projects/simple-schematics/menu-list.png)
