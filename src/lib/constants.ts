export const BASE_URL = "https://vahor.fr";
...
export const HEADER_LINKS = [{ label: "Blog", href: "/tag/all" }];

export const globalMetadata = {
	title: { default: "Vahor", template: "%s | Vahor" },
	...
	authors: [{ name: "Nathan David", url: "https://vahor.fr" }],
	twitter: {
		creator: "@vahor_",
		card: "summary",
		images: [
